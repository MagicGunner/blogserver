...
import com.typemoon.service.TalkService;
...
import static com.typemoon.enums.TalkStatusEnum.PUBLIC;
...
public class TalkServiceImpl extends ServiceImpl<TalkMapper, Talk> implements TalkService {
    ...
    public PageResultDTO<TalkDTO> listTalks() {
        int count = Math.toIntExact(talkMapper.selectCount((new LambdaQueryWrapper<Talk>()
