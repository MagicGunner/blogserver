...
import com.typemoon.enums.CommentTypeEnum;
import com.typemoon.exception.BizException;
import com.typemoon.mapper.ArticleMapper;
import com.typemoon.mapper.CommentMapper;
import com.typemoon.mapper.TalkMapper;
...
import com.typemoon.util.HTMLUtil;
...
import static com.typemoon.constant.RabbitMQConstant.EMAIL_EXCHANGE;
import static com.typemoon.enums.CommentTypeEnum.*;
...
public class CommentServiceImpl extends ServiceImpl<CommentMapper, Comment> implements CommentService {
    ...
    public PageResultDTO<CommentDTO> listComments(CommentVO commentVO) {
        int commentCount = Math.toIntExact(commentMapper.selectCount(new LambdaQueryWrapper<Comment>()
