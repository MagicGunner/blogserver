...
import com.typemoon.mapper.MenuMapper;
...
import com.typemoon.service.MenuService;
...
import static com.typemoon.constant.CommonConstant.COMPONENT;
...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
    ...
    public void deleteMenu(Integer menuId) {
        int count = Math.toIntExact(roleMenuMapper.selectCount(new LambdaQueryWrapper<RoleMenu>()
